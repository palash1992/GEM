...
**Update**: Note that this is a library for static graph embedding methods. For evolving graph embedding methods, please refer [DynamicGEM](https://github.com/palash1992/DynamicGEM). We also recently released Youtube dynamic graph data setwhich can be found at [YoutubeGraph-Dyn](https://github.com/palash1992/YoutubeGraph-Dyn).
